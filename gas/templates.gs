...
この度は、関西学院大学 中小企業経営診断研究会無料経営相談分科会の
...
本日は関西学院大学 中小企業経営診断研究会無料経営相談分科会の
...
※受付にて「中小企業経営診断研究会無料経営相談分科会の相談予約」とお伝えください`;
  }
...
${data.method === 'オンライン' || data.method === 'オンライン（Zoom）' ? '・Zoomの接続テストを事前にお願いいたします\n・相談内容の品質向上・記録のため、原則として録画・録音をお願いしております' : '・当日は受付にて「中小企業経営診断研究会無料経営相談分科会の相談予約」とお伝えください'}
...
<head>
  ...
  <title>相談同意書のご確認 - 関西学院大学 中小企業経営診断研究会無料経営相談分科会</title>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>同意済 - 関西学院大学 中小企業経営診断研究会無料経営相談分科会</title>
  <style>
    body { font-family: 'Noto Sans JP', sans-serif; display: flex; justify-content: center; align-items: center; min-height: 100vh; background: #f5f5f7; }
...
<body>
  <div class="header">
    <h1>無料経営相談 アンケート</h1>
    <p style="font-size:0.8rem; opacity:0.8; margin-top:0.3rem;">関西学院大学 中小企業経営診断研究会無料経営相談分科会</p>
  </div>
...
先日は、関西学院大学 中小企業経営診断研究会無料経営相談分科会の無料経営相談をご利用いただき、
誠にありがとうございました。
