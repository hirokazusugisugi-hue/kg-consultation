# Googleフォーム日程アンケート v2 + LP改修 + ニュース管理 要件定義
...
━━ 開催確定枠（10枠） ━━
4/4(土) 14:00  配置点数:6  メンバー: 杉山 宏和,川崎 真規,小椋 孝博  ○
4/4(土) 16:00  配置点数:5  メンバー: 杉山 宏和,原 真人,野田 慎士    ○
4/4(土) 18:00  配置点数:4  メンバー: 川崎 真規,秋月 仁志            ○
...

━━ 開催中止枠（6枠） ━━
4/5(日) 18:00  配置点数:2  メンバー: 高乘 麻美,村本 将之            × メンバー不足
4/10(金) 20:30 配置点数:1  メンバー: 野田 慎士                      × メンバー不足
...
