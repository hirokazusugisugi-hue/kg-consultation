...
function buildNdaHtml(data) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8">' +
    ...
    '<p>私は、「中小企業経営診断研究会」（以下「本研究会」といいます）が実施する無料経営相談にオブザーバーとして出席するにあたり、個人の責任として、以下の事項を遵守することを誓約いたします。</p>' +
    '<p class="art">第1条（秘密情報の定義）</p>' +
    '<p>本誓約における「秘密情報」とは、本研究会の活動を通じて知り得た、相談企業の経営・財務・技術等の情報、関係者の個人情報、および活動中に作成された相談資料・録音データ等、一切の情報を指します。</p>' +
    '<p class="art">第2条（遵守事項）</p>' +
    '<p>1. 本研究会の正規メンバー以外の第三者に、秘密情報を開示・漏洩しないこと。</p>' +
    ...
    '<p>1. 本誓約の義務は、本研究会の活動終了後および養成課程修了後も存続するものとします。</p>' +
